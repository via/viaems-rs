    ...
    egui::ScrollArea::vertical().show(ui, |ui| {
        egui::CollapsingHeader::new("Sensors")
            ...
            .show(ui, |ui| {
                ...
                let render_fault = |ui: &mut egui::Ui, f: interface::SensorFault| match f {
                ...
                egui::Grid::new("position")
                    ...
                    .show(ui, |ui| {
                        ...
                        if !position.synced {
                            ...
                            let stripped = if let Some(s) = reason.strip_prefix("DECODER_") {
                                s
                            } else {
                                reason
                            };
        ...
        egui::CollapsingHeader::new("Calculations")
            .default_open(true)
            .show(ui, |ui| {
